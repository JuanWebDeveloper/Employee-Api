	...
	return (
		<div className="container mx-auto">
			<div className="content-alignment w-11/12 lg:w-2/5 lg:mt-0">
				<h2 className="text-center text-blue-700 font-pop font-semibold mb-4 text-3xl lg:text-4xl">Edit Employee</h2>

				<form className="relative w-full" onSubmit={(e) => updateEmployee(e)}>
