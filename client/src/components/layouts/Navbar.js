		...
		<React.Fragment>
			<nav className="flex fixed w-screen items-center justify-between flex-wrap bg-gradient-to-t from-blue-400 via-blue-500 to-blue-700 px-6 py-4 z-50">
				<Link to="/" className="flex items-center flex-shrink-0 text-white mr-6">
					...
					<span className="font-pop font-semibold text-3xl tracking-wider">RTL-CS</span>
				</Link>
				...
				<div className="w-full flex-grow hidden lg:flex lg:items-center lg:w-auto z-50" id="navigation">
					<div className="flex flex-col lg:flex-row lg:justify-end text-xl font-pop font-medium tracking-wide lg:flex-grow ">
						<Link to="/" className="block mt-4 lg:inline-block lg:mt-0 text-gray-200 hover:text-white lg:mx-10">
							Home
						</Link>
						<Link
							to="/employee/create"
